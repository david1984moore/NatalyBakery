  ...
  return (
    <section className="relative h-[100svh] max-h-[100dvh] w-full flex flex-col overflow-hidden shrink-0">
      ...
      <div className="flex md:hidden absolute inset-0 z-[1] flex-col">
        ...
        <footer
          className="absolute bottom-0 left-0 right-0 z-10 min-h-[52px] flex items-center justify-center px-3 sm:px-5 pt-2.5 pb-[max(0.75rem,env(safe-area-inset-bottom))] bg-gradient-to-r from-[#cca878] to-hero-600 hero-footer-bar-mobile shadow-[0_-10px_36px_rgba(0,0,0,0.38)]"
          ...
          <nav className="flex items-stretch justify-center gap-4 sm:gap-6 w-full max-w-sm mx-auto px-1">
            ...
            <div className="flex-1 min-w-0 min-h-[32px] flex">
              <Link
                href="/menu"
                prefetch={true}
                className="hero-footer-btn-taper w-full h-full min-h-[32px] py-1 px-0.5 sm:px-1 flex flex-col items-center justify-center gap-0.5 text-white text-sm font-medium lowercase border-[3px] border-white bg-gradient-to-r from-[#7a6150] to-[#664f3f] backdrop-blur-sm rounded-2xl"
              >
            ...
            {heroFooterLinks.map((link) => (
              <div key={link.labelKey} className="flex-1 min-w-0 min-h-[32px] flex">
                <Link
                  href={link.href}
                  prefetch={true}
                  className="hero-footer-btn-taper w-full h-full min-h-[32px] py-1 px-0.5 sm:px-1 flex flex-col items-center justify-center gap-0.5 text-white text-sm font-medium border-[3px] border-white bg-gradient-to-r from-[#7a6150] to-[#664f3f] backdrop-blur-sm rounded-2xl"
                >
