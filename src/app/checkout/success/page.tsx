...
function SuccessPageContent() {
  ...
  return (
    ...
    <div className="min-h-screen relative" style={{ background: 'linear-gradient(135deg, #F8ECDF 0%, #EFE2D2 100%)' }}>
      ...
      <div
        className="fixed inset-x-0 top-0 z-[100] safe-top mobile-header-hero-fill max-md:bg-hero-footer-gradient md:sticky md:top-0 md:bg-background md:backdrop-blur-sm md:border-b md:border-warmgray-200 md:shadow-sm max-md:shadow-none isolate"
        style={{ minHeight: '40px', width: '100%' }}
      >
        <div className="relative z-10 flex flex-col min-h-[40px] mobile-header-hero-fill max-md:bg-hero-footer-gradient max-md:border-b-0 border-b-[3px] border-b-white/85 md:bg-transparent md:border-b md:border-warmgray-200">
